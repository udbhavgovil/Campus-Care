...
<body background="background.jpg">
	...
	<table class="homebar">
		<tr>
			...
			<th><a href=""><font face="times new roman" size="4" color="white">GUEST</font></a></th>
	...
	<table class="login">
		<tr>
			<td>
				<form name="login" id="login" action="checklogin_guest.php" method="post">
					<p class="textbox">
					<font size="5px">
					Institute     
					</font>
					...
					<font size="5px">ID &nbsp&nbsp&nbsp&nbsp </font><input type="text" name="enroll" id="enroll" class="resizedTextbox" placeholder="Enrollment Number" required><font color="red">&nbsp*</font><br>	
